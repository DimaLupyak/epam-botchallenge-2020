...
namespace ICanCode.Api
{
    ...
    public struct Point
    {
        ...
        public Point RelativeToAbsolute(int windowSize, Point offset)
        {
            return new Point(X + offset.X, Y + Constants.FullBoardSize - windowSize - offset.Y);
        }

        public Point AbsoluteToRelative(int windowSize, Point offset)
        {
            return new Point(X - offset.X, Y - Constants.FullBoardSize + windowSize + offset.Y);
        }
        ...
        public int GetLengthTo(Point to)
        {
        ...
        public Point Shift(Point delta)
        {
